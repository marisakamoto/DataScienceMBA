...
neighbour_queen_level <- nblag(neighbours = neighbour_queen, maxlag = 5)


neighbour_queen_level[[1]] #Contiguidades de ordem 1

neighbour_queen_level[[2]] #Contiguidades de ordem 2
neighbour_queen_level[[3]] #Contiguidades de ordem 3

neighbour_queen_level[[4]] #Contiguidades de ordem 4
neighbour_queen_level[[5]] #Contiguidades de ordem 5

# Exemplo de plotagem com ordens superiores de contiguidades:
plot(shp_sp, border = "lightgray")
plot(neighbour_queen_level[[2]],
     coordinates(shp_sp),
     add = TRUE,
     col = "#33638DFF")
...
vizinhos_distancias <- dnearneigh(coordinates(shp_ba),
                                  ...
                                  d2 = 90,
                                  longlat = TRUE,
                                  row.names = shp_ba@data$MUNICIPIO)
...
# Utilizaremos o objeto neighbour_queen:
neighbour_queen

# A matriz binária W de pesos espaciais do objeto neighbour_queen está no objeto 
# matrizW_queen.

# Para a definição da matriz W padronizada em linha:
matrizW_queen_linha <- nb2mat(neighbour_queen,
                              style = "W",
                              zero.policy = TRUE)
...
matrizW_queen_dupla_padr <- nb2mat(neighbour_queen,
                                   style = "U",
                                   zero.policy = TRUE)
...
# Para a definição da matriz W duplamente padronizada:
matrizW_queen_est_var <- nb2mat(neighbour_queen,
                                style = "S",
                                zero.policy = TRUE)
